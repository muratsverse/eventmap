      ...
      <div className="bg-gray-800 rounded-xl shadow-xl max-w-md w-full p-6 border border-gray-700">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Happenin'a Hoş Geldiniz!</h2>
        ...
        <div className="mb-6">
          <p className="text-gray-300 mb-4">
            Hesap oluşturmak ister misiniz? Happenin'da etkinlikleri keşfedebilir, favorilerinize ekleyebilir ve daha fazlasını yapabilirsiniz.
          </p>
