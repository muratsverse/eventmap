...
export function EventCardSkeleton() {
  return (
    <div className="rounded-3xl overflow-hidden animate-pulse bg-[var(--surface)] border border-[var(--border)]">
      {/* Image skeleton */}
      ...
      <div className="p-4 space-y-3">
        {/* Category badge */}
        <div className="h-6 w-24 bg-[var(--surface-2)] rounded-full" />
        ...
        <div className="flex justify-between items-center pt-2">
          <div className="h-6 w-20 bg-[var(--surface-2)] rounded-lg" />
          <div className="h-8 w-24 bg-[var(--surface-2)] rounded-xl" />
        </div>
      </div>
    </div>
  );
...
export function EventCardCompactSkeleton() {
  return (
    <div className="rounded-2xl p-4 flex gap-4 animate-pulse bg-[var(--surface)] border border-[var(--border)]">
      {/* Image skeleton */}
      <div className="w-20 h-20 bg-[var(--surface-2)] rounded-xl flex-shrink-0" />
...
export function MapMarkerSkeleton() {
  return (
    <div className="w-10 h-10 bg-[var(--surface-2)] rounded-full animate-pulse" />
  );
}
  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="px-4 -mt-16 relative z-10">
        <div className="rounded-3xl p-6 bg-[var(--surface)] border border-[var(--border)]">
          <div className="flex items-start gap-4">
            {/* Avatar */}
            <div className="w-20 h-20 bg-[var(--surface-2)] rounded-2xl flex-shrink-0" />
...
export function ButtonSkeleton({ className = '' }: { className?: string }) {
  return <div className={`bg-[var(--surface-2)] rounded-xl animate-pulse h-10 ${className}`} />;
}

// Image skeleton with lazy loading support
export function ImageSkeleton({ className = '' }: { className?: string }) {
  return <div className={`bg-[var(--surface-2)] animate-pulse ${className}`} />;
}
